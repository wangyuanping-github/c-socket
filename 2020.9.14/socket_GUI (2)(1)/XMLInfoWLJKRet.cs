...
{
    public partial class XMLInfoWLJKRet : UserControl
    {
        public XMLInfoWLJKRet()
        {
            InitializeComponent();
        }

        private void XMLInfoWLJKRet_Load(object sender, EventArgs e)
        {
        ...
        private void send_xml_Click(object sender, EventArgs e)
        {
            ...
            rootFirst.SetAttribute("SEQ_NO", "00000000000000000000");//SEQ_NO为20位的字符串。表示报文的序列号，为当时报文唯一标志，在返回放行指令的时候，需要原文返回
